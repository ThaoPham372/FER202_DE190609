 ...
 */
export const fetchMotorbikesAction = async (dispatch) => {
  try {
    const response = await axios.get(API_URL);
    dispatch({ type: 'SET_MOTORBIKE', payload: response.data });
  } catch (error) {
 ...
 */
export const addMotorbikeAction = async (dispatch, expenseData) => {
  try {
    const response = await axios.post(API_URL, expenseData);
    dispatch({ type: 'ADD_MOTORBIKE', payload: response.data });
    return { success: true };
  } catch (error) {
 ...
 */
export const deleteMotorbikeAction = async (dispatch, id) => {
  try {
    await axios.delete(`${API_URL}/${id}`);
    dispatch({ type: 'DELETE_MOTORBIKE', payload: id });
  } catch (error) {
 ...
 */
export const updateMotorbikeAction = async (dispatch, id, expenseData) => {
  try {
    const response = await axios.put(`${API_URL}/${id}`, expenseData);
    dispatch({ type: 'UPDATE_MOTORBIKE', payload: response.data });
    return { success: true };
  } catch (error) {
